...
class MainActivity : AppCompatActivity() {
    ...
    data class Lemonade(
        ...
        var sCount:Int =0,
        var lsize:Int = lemonTree.pick()
    )
    private fun squeeze(lemonade : Lemonade){
        lemonade.sCount=lemonade.sCount + 1
        lemonade.lsize = lemonade.lsize - 1
    ...
    private fun clickLemonImage() {
        ...
        val lemonade = Lemonade(lemonTree)
//        var scount = 0
//        var lsize = 1//lemonTree.pick()
        when(lemonadeState){
            SELECT -> {

                lemonadeState = SQUEEZE
                lemonSize = lemonade.lsize
                squeezeCount = lemonade.sCount
    ...
    private fun setViewElements() {
        ...
        val drawImage = when(lemonadeState){
        ...
        imageView.setImageResource(drawImage)
